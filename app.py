...
app = Flask(__name__)
app.secret_key = 'RFG2025FC'  # Cambia esto por una clave secreta segura
...
VERSION_APP = "Versión 1.1 del 03-06-2025"
CREATOR_APP = "Luis Carlos Caballero"
mongo_uri   = os.environ.get("MONGO_URI")

if not mongo_uri:   
    uri         = "mongodb+srv://DbCentral:dbcentral2025@cluster0.zxbcj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
    mongo_uri   = uri
...
client = Elasticsearch(
    "https://bigdataproject-fef49b.es.us-east-1.aws.elastic.cloud:443",
    api_key="MWdybVBaY0I1dUZSMmZaWVFTaEY6dk1XaFJQUGtJZHhTeGZTZEs1REhrdw=="   
)
INDEX_NAME = "u_central_project"
